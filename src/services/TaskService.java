        ...
        if (TaskService.gI().isCurrentTask(player, idTaskCustom)) {
            ...
            switch (idTaskCustom) {
                ...
                case ConstTask.TASK_32_5:
                    npcSay(player, ConstNpc.BARDOCK,
                            "Ngươi rất VIP nhưng hơi non!\nGiờ ngươi đã là trùm server nhưng rất tiếc không phải vua cờ bạc\nHãy gặp ngay V2 Tiến Bry và nhận hắn làm thầy\nĐi đi! Ngươi nhất định sẽ trở thành vua cờ bạc!");
                    break;
